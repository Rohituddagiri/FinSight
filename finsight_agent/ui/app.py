...
def main():
    ...
    with st.sidebar:
        ...
        example_queries = [
            ...
            "How much cash does Apple have on hand right now?",
            "How much did Apple spend on R&D last year?"
            "Compare Apple’s liabilities with its assets.",
            "What was the value of Apple’s current liabilities in FY2023?",
            "Give me Apple’s net income trend for the past 3 quarters"
        ]
    ...
    # Chat input
    if prompt := st.chat_input("Ask me to search SEC Filings..."):
