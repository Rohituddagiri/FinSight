"""Host Agent tools for A2A communication with SEC agent.
...
from config import SEC_AGENT_A2A_URL
...
AGENT_URL_MAP: Dict[str, str] = {
    ...
    "sec_agent": "https://ae43-65-38-124-250.ngrok-free.app/.well-known/agent.json"
}
...
async def delegate_task(agent_name: str, task_description: str) -> str:
    ...
    Args:
        agent_name: The logical name of the target agent (e.g., 'sec_agent').
